function [xx, yy] = secdraw(start_angle, sector_angle, radius, centre, color)
...
if nargout < 2
    patch(xx, yy, 'b','EdgeColor', color, 'FaceColor', 'none')%,'EraseMode','none');
end
