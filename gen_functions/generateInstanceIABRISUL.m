...
instance.v_los = channel.access_rates_full(1:uniform_n_tp,1:uniform_n_cs,1:uniform_n_cs);
instance.v_nlos = channel.access_rates_partial(1:uniform_n_tp,1:uniform_n_cs,1:uniform_n_cs);
instance.v_los_ul = channel.access_rates_full(1:uniform_n_tp,1:uniform_n_cs,1:uniform_n_cs);
instance.v_nlos_ul = channel.access_rates_partial(1:uniform_n_tp,1:uniform_n_cs,1:uniform_n_cs);
instance.v_nlos(instance.v_nlos == 0) = 0.01;
instance.v_nlos_ul(instance.v_nlos_ul == 0) = 0.01;

%maximum airtime calculation
max_airtime_dl_dir=max(instance.d/instance.v_los(~isinf(instance.v_los)),[],'all');
max_airtime_dl_ref=max(rate_ratio*instance.d/instance.v_nlos(~isinf(instance.v_nlos)),[],'all');

max_airtime_ul_dir=max(instance.d_ul/instance.v_los_ul(~isinf(instance.v_los_ul)),[],'all');
max_airtime_ul_ref=max(rate_ratio*instance.d_ul/instance.v_nlos_ul(~isinf(instance.v_nlos_ul)),[],'all');

instance.max_airtime_dl = max(max_airtime_dl_dir, max_airtime_dl_ref);
instance.max_airtime_ul = max(max_airtime_ul_dir, max_airtime_ul_ref);
