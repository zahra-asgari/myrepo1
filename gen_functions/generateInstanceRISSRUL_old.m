...
max_airtime_dl_ris=max(rate_ratio*instance.d/instance.v_nlos(~isinf(instance.v_nlos)),[],'all');
max_airtime_dl_sr=max(rate_ratio*instance.d/instance.v_nlos_sr(~isinf(instance.v_nlos_sr)),[],'all');

max_airtime_ul_dir=max(instance.d_ul/instance.v_los_ul(~isinf(instance.v_los_ul)),[],'all');
max_airtime_ul_ris=max(rate_ratio*instance.d_ul/instance.v_nlos_ul(~isinf(instance.v_nlos_ul)),[],'all');
max_airtime_ul_sr=max(rate_ratio*instance.d_ul/instance.v_nlos_sr_ul(~isinf(instance.v_nlos_sr_ul)),[],'all');
