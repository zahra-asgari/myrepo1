function [direct_rate,reflected_rate,bh_rate] = channel_computation_eugenio(cs_tp_distance_matrix,cs_cs_distance_matrix, scenario)
...
n_antennas = scenario.radio.n_antennas;
ris_components = scenario.radio.ris_components;
p_tx = scenario.radio.p_tx;
bandwidth = scenario.radio.bandwidth;
ue_noise_fig = scenario.radio.ue_noise_fig;
bs_noise_fig = scenario.radio.bs_noise_fig;
