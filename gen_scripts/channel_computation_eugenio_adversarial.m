function [direct_rate,reflected_rate] = channel_computation_eugenio_adversarial(cs_tp_distance_matrix,cs_cs_distance_matrix, scenario)
%CHANNEL_COMPUTATION_EUGENEIO_ADVERSARIAL Summary of this function goes here
%   Detailed explanation goes here

[n_cs, n_tp, P] = size(cs_tp_distance_matrix);

direct_rate = zeros(n_tp,n_cs,P);
reflected_rate = zeros(n_tp,n_cs,n_cs,P);
